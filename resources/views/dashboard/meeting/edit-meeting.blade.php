                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="campaignName" name="start_time" class=" form-control-success form-control" value="{{ date('h:i a', strtotime($meeting->start_time))}}" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="inputIsValid" class=" form-control-label">End Time</label>
                                            <input type="text" id="campaignName" name="end_time" class=" form-control-success form-control" value="{{ date('h:i a', strtotime($meeting->end_time))}}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
